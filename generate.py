...
class maze:
    ...
    functions
    ---------
    backtrack : form the labyrinth of a 'n' size with a backtracking algorithm
    show      : print with a little style the labyrinth
    kruskal   : form the labyrinth of a 'n' size with a kruskal algorithm
    """
